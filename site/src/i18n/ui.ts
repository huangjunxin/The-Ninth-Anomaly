 ...
 *
 * The English and Chinese UIs read the English manuscript; the Japanese UI
 ...
 * zh lives under `/zh/`, ja under `/ja/`. See astro.config.mjs.
 */
...
export const ui: Record<Locale, UiDict> = { en, zh, ja };
 ...
 * `/zh/chapters/chapter-01/` → `/chapters/chapter-01/`, `/ja` → `/`.
 */
